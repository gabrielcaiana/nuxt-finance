...
<template>
  <div
    v-if="show"
    id="toast-success"
    class="fixed right-6 top-6 mb-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
    role="alert"
  >
    <div
